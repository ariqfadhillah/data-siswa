				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.html">Home </a>  <span class="lnr lnr-arrow-right"></span><a href="blog-home.html">Blog </a> <span class="lnr lnr-arrow-right"></span> <a href="{{$post->slug}}"> {!!$post->slug!!}</a></p>
						</div>	
					</div>
				</div>
			</section>
							...
							<div class="single-post row">
								...
								<div class="col-lg-3  col-md-3 meta-details">
									<div class="user-details row">
										...
										<p class="date col-lg-12 col-md-12 col-6"><a href="#">{{$post->created_at->format('D, d M Y')}}</a> <span class="lnr lnr-pencil"></span></p>
